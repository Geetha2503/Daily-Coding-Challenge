<h2> 200 16
3202. Find the Maximum Length of Valid Subsequence II</h2><hr><div>You are given an integer array <code>nums</code> and a <strong>positive</strong> integer <code>k</code>.
