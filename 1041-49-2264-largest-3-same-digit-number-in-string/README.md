<h2> 1041 49
2264. Largest 3-Same-Digit Number in String</h2><hr><div><p>You are given a string <code>num</code> representing a large integer. An integer is <strong>good</strong> if it meets the following conditions:</p>
