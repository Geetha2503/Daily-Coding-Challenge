<h2> 70 6
3365. Rearrange K Substrings to Form Target String</h2><hr><div><p>You are given two strings <code>s</code> and <code>t</code>, both of which are anagrams of each other, and an integer <code>k</code>.</p>
