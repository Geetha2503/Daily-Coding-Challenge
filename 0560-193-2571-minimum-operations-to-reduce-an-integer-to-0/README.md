<h2> 560 193
2571. Minimum Operations to Reduce an Integer to 0</h2><hr><div><p>You are given a positive integer <code>n</code>, you can do the following operation <strong>any</strong> number of times:</p>
